...
my_column <- "gut.region" #metadata column to be used in the taxa barplot

rm(taxa.summary)

abund_filter <- 0.05 #abundance threshold
#ml ="Genus"
...
alpha = 0.05
#my_contrast = c("treatment", "control", "group 1") 
#my_contrast = c("treatment", "control", "group 2") 
#my_contrast = c("treatment", "control", "group 3") 
#my_contrast = c("treatment", "group 1", "group 2") 
#my_contrast = c("treatment", "group 1", "group 3") 
#my_contrast = c("treatment", "group 2", "group 3") 
